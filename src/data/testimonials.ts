...
export const testimonials: Testimonial[] = [
  {
    ...
    company: "InnovateX",
    quote:
      "AAM Developer transformed our business with a custom CRM solution that increased our team efficiency by 40%. Their expertise and commitment to quality are unmatched in the industry.",
    rating: 5,
    avatar:
